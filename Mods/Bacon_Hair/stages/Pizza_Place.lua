...
makeLuaSprite('bg', 'Pizza_Place', -2150, -900);
makeLuaSprite('ui', 'Pizza_UI', 0, 0);


makeAnimatedLuaSprite('p', 'Pizza', -1200, -1000)
addAnimationByPrefix('p', 'dp', 'downpizza', 24, true)

makeAnimatedLuaSprite('b', 'Burger', -1200, -1000)
addAnimationByPrefix('b', 'db', 'downburger', 24, true)

makeAnimatedLuaSprite('m', 'Mad', -1445, -640)
addAnimationByPrefix('m', 'pa', 'popanger', 24, true)
